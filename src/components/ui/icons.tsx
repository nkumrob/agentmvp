...
export function TuningIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LearningIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KnowledgeIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StepOneIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StepTwoIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StepThreeIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
