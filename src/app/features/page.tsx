      ...
      <main className="flex-1 container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400 mb-8">
            This is a placeholder for the features page. The actual features content will be implemented soon.
          </p>
          <div className="flex flex-col space-y-4 items-center">
            <Link href="/features/ingestion">
              <Button variant="outline" className="w-48">Data Ingestion</Button>
            </Link>
            <Link href="/features/fine-tuning">
              <Button variant="outline" className="w-48">Fine-Tuning Studio</Button>
            </Link>
            <Link href="/features/analytics">
              <Button variant="outline" className="w-48">Analytics Dashboard</Button>
            </Link>
            <Link href="/">
              <Button className="w-48 mt-8">Back to Home</Button>
            </Link>
          </div>
        </div>
      </main>
