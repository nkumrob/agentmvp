...
INSERT INTO "new_DataSource" ("agentId", "content", "createdAt", "id", "name", "sourceType", "sourceUrl", "status", "updatedAt") SELECT "agentId", "content", "createdAt", "id", "name", "sourceType", "sourceUrl", "status", "updatedAt" FROM "DataSource";
